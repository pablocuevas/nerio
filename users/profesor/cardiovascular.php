        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="cardiovascular.php"><i class="icon-chevron-right"></i>Cardiovascular</a></li>
              <li><a href="muscular.php"><i class="icon-chevron-right"></i>Muscular</a></li>
            </ul>
          </div><!--/.well -->
        </div><!--/span-->
        <div class="span9">
		<h1>Ficha cardiol&oacute;gica</h1>
            <form class="well" name="cardio" method="POST" action="guardarficha.php">
            	<label> Fecha</label>
				...
				<label>Programa</label><select name="programa">
					<option>.....</option></br>
					<option>Cardio</option></br>
					<option>Hill</option></br>
					<option>Normal</option></br>
					<option>Random</option></br>
					<option>Test</option></br>
					</select></br>
				<label>Tiempo (min)</label><select name="programa">
					<option>.....</option></br>
					<option>10</option></br>
					<option>15</option></br>
					<option>20</option></br>
	            ...
	            <br>
	            <input name="tipoficha" id="tipoficha" type="hidden" value="cardio"/>
